clear
bi='\033[34;1m' #biru                                                       i='\033[32;1m' #ijo
...
sleep 1
clear
echo $ku"Author: unkn0wn"
echo $me"Anggota paradox"
echo $cy"MeNu BRUTEPORCE NeWS:"
echo $ku"["$me"1"$ku"]"$i" REPORT FB"
echo $ku"["$me"2"$ku"]"$i" BRUTE PORCE"
echo $ku"["$me"3"$ku"]"$i" BRUTE FORCE FB CRACKER"                          echo $ku"["$me"4"$ku"]"$i" MBF"
...
if [ $pil = 1 ]
then
clear                                                                       figlet -f slant "W A I T"|lolcat
sleep 1
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/jaxBCD/FBshield.git                            cd FBshield
python2 guard.py
fi
